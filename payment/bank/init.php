...
$pname = rand(1000,10000). "-" .$_FILES["pname"]["name"];
$tname = $_FILES["pname"]["tmp_name"];
$uploads_dir = 'prescription_image/';
move_uploaded_file($tname, $uploads_dir. '/' . $pname);

$dname = rand(1000,10000). "-" .$_FILES["dname"]["name"];
$tname = $_FILES["dname"]["tmp_name"];
$uploads_dir = 'discount_image/';
move_uploaded_file($tname, $uploads_dir. '/' . $dname);
